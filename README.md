...
O HashifyPass é um trabalho criado com base no trabalho anterior hashify.js, que pode ser encontrado [neste repositório](https://gitlab.com/jorgemiguelribeiro92/hashify). As poucas modificações que foram realizadas no arquivo src/hashify.js podem ser encontradas [neste link](https://www.diffchecker.com/BL3EEMHL). O HashifyPass propriamente dito está no arquivo src/hashifypass.js.
